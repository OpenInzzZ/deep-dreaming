 ...
 *
 * `webServer` is a **static** `inject` dependency, not a dynamic
 ...
 * the static form is unaffected — and it is what makes the carrier actually
 * present here, since Cordis mounts rows in parallel and `webServer` binds
